...
outcomes:
  - Layer diagram (UI, server actions, domain, data, edge) with ownership notes
  - Folder and module boundary recommendations matched to the repo
  - Explicit deferrals to next-server-patterns caching auth and data-layer skills
stack:
  - next
  - react
  - typescript
...
export const nextArchitecture = defineSkill({
  name: "next-architecture",
  description: "App-wide Next.js App Router architecture - layers, boundaries, folder strategy, and when to split services without cloning Vercel react-best-practices",
  ...
  outcomes: ["Layer diagram (UI, server actions, domain, data, edge) with ownership notes","Folder and module boundary recommendations matched to the repo","Explicit deferrals to next-server-patterns caching auth and data-layer skills"],
  stack: ["next","react","typescript","pnpm"],
  references: ["references/stack-nextjs.md","references/react-stack.md","references/skill-safety.md","references/data-layer-choice.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/next-architecture/SKILL.md",
});

export default nextArchitecture;
