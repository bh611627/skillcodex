...
export const skillcodexBrowserUi = defineSkill({
  ...
  outcomes: ["Four routes live with skeletons and skills.sh gaps filled (outcomes, copy, create, guidelines)","Apple-level whitespace doc UI using Tailwind; motion only via Tier 0 CSS or Tier 2 client leaf"],
  stack: ["pnpm","next","react","typescript","tailwindcss","react-icons"],
  references: ["references/design-guidelines.md","references/data-source.md","references/react-stack.md","references/skill-safety.md"],
