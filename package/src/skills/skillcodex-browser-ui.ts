...
export const skillcodexBrowserUi = defineSkill({
  ...
  version: "1.2.0",
  category: "development",
  outcomes: ["Four routes wired to real SKILL.md data when user supplied it, or minimal mock seed only when none exists","react-icons default; Emoji Mart apple set only if user wants emoji picker"],
  stack: ["pnpm","next","react","typescript","tailwindcss","framer-motion","react-icons"],
  references: ["references/react-stack.md","references/data-source.md","references/DESIGNSPEC.md","references/ui-pages.md","references/components.md","references/icons-and-emoji.md","references/publishing.md"],
