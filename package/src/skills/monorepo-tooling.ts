...
outcomes:
  - Workspace package graph description apps packages tooling
  - turbo pipeline keys for lint test build with dependsOn
  - Guidance on env and next transpilePackages when needed
stack:
  - pnpm
  - turbo
  - next
...
export const monorepoTooling = defineSkill({
  ...
  outcomes: ["Workspace package graph description apps packages tooling","turbo pipeline keys for lint test build with dependsOn","Guidance on env and next transpilePackages when needed"],
  stack: ["pnpm","turbo","next"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/monorepo-tooling/SKILL.md",
});

export default monorepoTooling;
