...
export const documentationUi = defineSkill({
  ...
  outcomes: ["Tokens, cards, skeletons, theme toggle wired with Apple-level whitespace","Mobile-first Tailwind layout ready for pnpm dev"],
