...
outcomes:
  - file:line audit report grouped by critical, major, minor
  - Checklist mapping findings to WCAG 2.2 AA success criteria
stack:
  - react
  - next
  - typescript
...
export const accessibilityAudit = defineSkill({
  ...
  outcomes: ["file:line audit report grouped by critical, major, minor","Checklist mapping findings to WCAG 2.2 AA success criteria"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/accessibility-audit/SKILL.md",
});
