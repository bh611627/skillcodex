...
- after merge, your skill ships with the bundle; optionally users can still use `npx skills add bh611627/skillcodex --skill web-design-guidelines` for your standalone repo.
...
## Source
Derived from [bh611627/skillcodex](https://github.com/bh611627/skillcodex) (MIT). References co-located under `skills/skillcodex-doc-ui/references/`.
...
| Goal | Action |
|------|--------|
| Users install SkillCodex skills | Share: `npx skills add bh611627/skillcodex --skill <name>` |
