...
`https://github.com/bh611627/skillcodex/tree/main/skills/<name>/SKILL.md`
...
| **[skills.sh](https://www.skills.sh/)** | `npx skills add owner/repo` | Compatible layout; e.g. `npx skills add bh611627/skillcodex --skill web-design-guidelines` |
