...
export const securityHeaders = defineSkill({
  ...
  outcomes: ["Header set table with values suited to Next static and dynamic routes","CSP directive list separating script style img connect fonts","Rollout plan report-only first then enforce"],
  stack: ["next","typescript"],
  references: ["references/csp-headers.md","references/skill-safety.md","references/stack-nextjs.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/security-headers/SKILL.md",
});
