...
outcomes:
  - Failing test that names the behavior before production code changes
  - Minimal green implementation and a short refactor note
  - Explicit list of what remains for Playwright E2E vs unit/integration
stack:
  - vitest
  - typescript
  - react
...
**GitHub:** https://github.com/bh611627/skillcodex/tree/main/skills/tdd-vitest/SKILL.md  
**npm:** https://www.npmjs.com/package/@skillcodex/skills
`;

export const tddVitest = defineSkill({
  name: "tdd-vitest",
  description: "Red-green-refactor test strategy with Vitest and Testing Library for React and Next - methodology before mass test generation",
  tags: ["tdd","vitest","testing-library","react"],
  version: "1.0.0",
  category: "development",
  ...
  outcomes: ["Failing test that names the behavior before production code changes","Minimal green implementation and a short refactor note","Explicit list of what remains for Playwright E2E vs unit/integration"],
  stack: ["vitest","typescript","react","next"],
  references: ["references/skill-safety.md","references/react-stack.md","references/stack-nextjs.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/tdd-vitest/SKILL.md",
});

export default tddVitest;
