...
outcomes:
  - Route-level error vs global-error decision table for the app
  - not-found triggers and parallel route unmatched fallbacks if used
  - loading.tsx and Suspense placement without layout thrash
stack:
  - next
  - react
  - typescript
...
export const errorLoadingNotFound = defineSkill({
  ...
  outcomes: ["Route-level error vs global-error decision table for the app","not-found triggers and parallel route unmatched fallbacks if used","loading.tsx and Suspense placement without layout thrash"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/error-loading-not-found/SKILL.md",
});

export default errorLoadingNotFound;
