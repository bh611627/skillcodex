...
export const reactEmailTemplates = defineSkill({
  ...
  outcomes: ["Component structure for one template with plain text fallback outline","Inline-friendly styles guidance tables not flex for clients","Preview and local send workflow commands only"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/react-email-templates/SKILL.md",
});

export default reactEmailTemplates;
