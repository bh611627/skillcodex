...
outcomes:
  - Priority-ordered review findings with file:line anchors where possible
  - Risk summary (security, data, UX, CI) and merge recommendation
  - Concrete suggested fixes that preserve the author's approach when sound
stack:
  - next
  - react
  - typescript
...
export const prReviewWorkflow = defineSkill({
  name: "pr-review-workflow",
  description: "Structured pull request review for React and Next.js - checklist, risk notes, and actionable comments without rewriting the PR",
  tags: ["pr-review","code-review","nextjs","github"],
  version: "1.0.0",
  category: "development",
  ...
  outcomes: ["Priority-ordered review findings with file:line anchors where possible","Risk summary (security, data, UX, CI) and merge recommendation","Concrete suggested fixes that preserve the author's approach when sound"],
  stack: ["next","react","typescript","pnpm"],
  references: ["references/skill-safety.md","references/stack-nextjs.md","references/react-stack.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/pr-review-workflow/SKILL.md",
});
