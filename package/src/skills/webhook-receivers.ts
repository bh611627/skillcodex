...
export const webhookReceivers = defineSkill({
  ...
  outcomes: ["Signature scheme per provider HMAC or RSA with clock skew note","Idempotency key storage pattern described not wired to specific DB","2xx vs 4xx matrix for retry behavior"],
  stack: ["next","typescript"],
  references: ["references/payments-pci.md","references/skill-safety.md","references/stack-nextjs.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/webhook-receivers/SKILL.md",
});

export default webhookReceivers;
