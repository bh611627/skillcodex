...
outcomes:
  - Transport choice matrix SSE one way server push vs WebSocket bidirectional
  - Auth pattern cookie session cannot auto attach to WS from browser note mitigations
  - Backpressure and max connections per instance operational notes
stack:
  - next
  - typescript
...
export const realtimeHandbook = defineSkill({
  name: "realtime-handbook",
  description: "SSE and WebSockets in Next.js Route Handlers - auth connection limits and when to pick each transport",
  tags: ["realtime","sse","websockets","nextjs"],
  version: "1.1.0",
  category: "development",
  ...
  outcomes: ["Transport choice matrix SSE one way server push vs WebSocket bidirectional","Auth pattern cookie session cannot auto attach to WS from browser note mitigations","Backpressure and max connections per instance operational notes"],
  stack: ["next","typescript"],
  references: ["references/realtime-transports.md","references/stack-nextjs.md","references/skill-safety.md"],
...
**npm:** https://www.npmjs.com/package/@skillcodex/skills`,
  skillMd,
  githubPath: "skills/realtime-handbook/SKILL.md",
});

export default realtimeHandbook;
