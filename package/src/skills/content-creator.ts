...
export const contentCreator = defineSkill({
  name: "content-creator",
  description: "Social hooks, scripts, and captions - clear deliverables, no fluff",
  tags: ["content","marketing","social"],
  version: "1.1.0",
  category: "marketing",
  outcomes: ["Three hooks you can test","Post body or script ready to edit and publish","Caption + hashtags that aren’t copy-paste spam"],
  stack: ["pnpm","next"],
  references: ["references/react-stack.md"],
...
**npm:** \`import skill from "@your-org/my-ai-skills/content-creator"\``,
  skillMd,
  githubPath: "skills/content-creator/SKILL.md",
});
